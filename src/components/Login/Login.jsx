  ...
  return (
    <div className="login">
      <div className="bg-sky-400 text-white font-semibold p-2 text-xl">
        <div className="bg-yellow-300 h-20 text-center">
          Lorem ipsum dolor sit amet.
        </div>
        <div className="bg-lime-500 text-center md:flex gap-3">
          <div className="bg-red-200 w-100 md:w-1/2">
            lado imagen
          </div>
          <div className="bg-zinc-100 p-10 w-100 md:w-1/2">
            <div className="bg-white pt-5 border border-teal-700">
              ...
              <form className="m-5 ">
                ...
                <p className="text-slate-700 text-sm font-normal">¿Aun no estás registrado?<span className="text-teal-700  text-base font-semibold">   registrarme</span></p>
              </form>
            </div>
          </div>
        </div>
