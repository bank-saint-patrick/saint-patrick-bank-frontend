      ...
      <div className="relative flex justify-center items-center">
        <div id="menu" className="w-full h-full bg-gray-900 bg-opacity-80 top-0 fixed sticky-0">
          <div className="h-screen flex justify-center items-center">
            <div className="h-full w-full bg-blue-stone relative flex flex-col justify-center items-center bg-white p-10">
              <div role="banner">
              </div>
              <div className="mt-12">
                <h1 role="main" className="text-3xl dark:text-white lg:text-4xl font-semibold leading-7 lg:leading-9 text-center text-gray-800">Estamos para ayudarte</h1>
              </div>
              <div className="mt">
              ...
              <div className="mt-10">
                <button className="py-5 px-10 mr-10 bg-white mb-10">
                  Tipo de ayuda 1
                </button>
                <button className="py-5 px-10 mr-10 bg-white mb-10">
                  Tipo de ayuda 2
              ...
              <div className="mt">
                <button 
                  className="mt-6 font-bold text-xl text-cream-can text-center"
