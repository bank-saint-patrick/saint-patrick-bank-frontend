...
export default function Call() {
  return (
    <div className="wrapper flex-column w-screen h-screen sm:overflow-x-hidden">
      <Navbar />
      <div className="w-max flex flex-col-reverse md:flex-row items-center justify-center relative z-10 container m-auto">
        <div className="w-full mx-3 lg:mx-20 ">
          <img
            aria-label="people smiling"
            className="h-full justify-center items-center object-contain mx-auto"
            src={call}
            alt="people smiling"
          />
        </div>

        <div className="w-full flex block mx-3 lg:mx-20">
          <div className="bg-white flex flex-col justify-center">
            <span className="text-plantation text-2xl text-center font-semibold my-5">
              ¡Por favor ingresá tus datos en los espacios de abajo, asi
              podremos contactarte!
            </span>
            <form className="text-center my-5">
              <input
                className="flex-col bg-white border border-1 border-teal-700 mx-auto w-full p-1 rounded-xl py-3 my-3 font-semibold "
                type="text"
                label="nombre"
