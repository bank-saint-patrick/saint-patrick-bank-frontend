...
export default function Call() {
    ...
    return (
        <div className="wrapper flex-column w-screen h-screen sm:overflow-x-hidden">
            <Navbar />
            <div className="w-max flex h-full flex-col-reverse lg:flex-row items-center justify-center relative z-10 container m-auto">
                ...
                <div className="w-full block mx-3 lg:mx-20">
                    <div className="bg-white flex flex-col justify-center">
                        ...
                        <form className="text-center my-5">
                            <input className="flex-col bg-white border border-1 border-teal-700 mx-auto w-full p-3 rounded-xl py-3 my-3 font-semibold " type="text" label="nombre" placeholder="Escribe tu Nombre" />
                            <input className="flex-col bg-white border border-1 border-teal-700 mx-auto w-full p-3 rounded-xl py-3 my-3 font-semibold " type="phone" label="phone" placeholder="Escribe tu teléfono" />
                        </form>
