                    ...
                    <div className="flex md:flex-row flex-col-reverse md:items-stretch items-center justify-center">
                        <div className="md:py-20 xl:w-1/2 sm:w-1/2 lg:mr-20 md:mr-6 flex flex-col md:items-end items-center justify-center xl:mr-28">
                            <div className="flex flex-col items-center justify-center w-full">
                                ...
                                <p className="w-full mt-6 text-base leading-6 text-center text-gray-600">
                                    Plataforma web de educación financiera creada con la finalidad de promover la inclusión financiera y digital de los adultos mayores en el país.
                                </p>
                                <div className="md:mt-14 mt-12 flex flex-col items-center">
                                    <div className="w-20 h-20 bg-white shadow rounded-full flex items-center justify-center" role="img" aria-label="money">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="text-[#4338CA] h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                                    ...
                                    <p className="text-base leading-6 mt-6 text-center text-gray-600 sm:w-96 w-full">
                                        Nuestro objetivo es brindar herramientas que permitan facilitar el acceso de aprendizaje de los productos y servicios bancarios a través de un lenguaje claro y herramientas dinámicas.
                                    </p>
                                </div>
                                <div className="mt-7 flex flex-col items-center">
                                    ...
                                    <p className="text-base leading-6 mt-6 text-center text-gray-600 sm:w-96 w-full">
                                        Queremos que te sientas acompañado, comprendido, escuchado y que puedas tomar contacto con una persona real para responder tus dudas y consultas de forma personalizada en todo momento.
                                    </p>
                                </div>
                                <div className="mt-7 flex flex-col items-center">
                                    ...
                                    <p className="text-base leading-6 mt-6 text-center text-gray-600 sm:w-96 w-full">
                                        Si con los tutoriales y nuestro sector de soporte en línea todavía te quedan dudas sobre cómo se utiliza nuestra plataforma. ¡No te preocupes!
                                    </p>
                                </div>
                                <div className="mt-7 flex flex-col items-center">
