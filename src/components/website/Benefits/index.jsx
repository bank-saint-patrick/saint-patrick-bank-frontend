...
export default function Benefits() {
    ...
    return (
        <div className="wrapper flex-column h-screen">
            ...
            <div className="flex lg:hidden items-center justify-center py-10 lg:px-0 sm:px-6 px-4">
                <div className="lg:w-3/5 w-full flex items-center justify-around sm:justify-between border-t border-gray-200">
                    <div
                        onClick={() => {
                            if (indexBenefit === 1) {
                            ...
                            if (index + 1 === indexBenefit) {
                                return (
                                    <p
                                        ...
                                        key={benefit.id}
                                        className="text-lg font-medium leading-none cursor-pointer text-indigo-700 border-t border-indigo-400 pt-3 mr-4 px-2">
                                        {index + 1}
                                    </p>
                                );
                            } else {
                                return (
                                    <p
                                        ...
                                        key={benefit.id}
                                        className="text-lg font-medium leading-none cursor-pointer text-gray-600 hover:text-indigo-700 border-t border-transparent hover:border-indigo-400 pt-3 mr-4 px-2">
                                        {index + 1}
                                    </p>
                                );
                            }
