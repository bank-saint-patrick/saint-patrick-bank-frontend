    ...
    <div className="wrapper flex-column h-screen">
      ...
      <div className="grid grid-rows-4 mt-7 w-auto h-fit md:grid-cols-4 md:space-x-4 lg:grid-cols-3 lg:space-x-9 xl:grid-cols-4 2xl:grid-cols-4">
        <div className="flex flex-row mt-1 mx-2 text-plantation px-3 py-9 pb-2 w-11/12 h-40 overflow-x-scroll space-x-10 justify-start space-y-9 bg-gray-100 rounded-lg shadow-lg shadow-slate-500 sm:flex-col sm:w-80 sm:overflow-x-hidden sm:h-max md:flex-col md:px-16 md:space-x-1 md:w-48 md:h-full md:overflow-x-hidden lg:flex-col lg:py-10 lg:w-60 xl:flex-col xl:w-64 xl:space-x-3.5 2xl:flex-col 2xl:w-64">
          ...
          <Link to='/#' className='underline font-serif w-24'>Combustible</Link>
          <Link to='/#' className='underline font-serif w-72'>Comprar online</Link>
          <Link to='/#' className='underline font-serif w-24'>Hogar</Link>
          <Link to='/#' className='underline font-serif w-24'>Construcción</Link>
          <Link to='/#' className='underline font-serif w-44'>Cuidado personal</Link>
          <Link to='/#' className='underline font-serif w-24'>Educación</Link>
          <Link to='/#' className='underline font-serif w-24'>Novedades</Link>
          <Link to='/#' className='underline font-serif w-24'>Servicios</Link>
          <Link to='/#' className='underline font-serif w-44'>Viajes y turismo</Link>
        </div>
        ...
        <div className='mx-auto my-0 py-0 flex flex-col gap-5 md:px-4 md:py-4 md:flex-col lg:pl-7 lg:py-4 lg:flex-col lg:pr-5 xl:py-4 xl:flex-col 2xl:py-4 2xl:flex-col' id='row2'>
          <div className='bg-blue-300 text-center px-auto py-4 w-80 h-60 rounded-md ml-auto sm:w-44 sm:h-80 sm:ml-1 sm:py-2 sm:text-sm sm:space-y-1.5 md:ml-auto md:py-0 md:px-2 md:space-y-0 md:py-2 md:w-48 md:h-72 lg:ml-auto lg:py-4 lg:w-80 lg:h-56 lg:space-y-1.5 xl:ml-0 xl:py-4 xl:w-80 xl:space-y-0.5 xl:h-56'>
            <h6 className='text-2xl font-bold'>20%</h6>
            <p className='text-md font-bold'>¡COBRANDO TUS HABERES, JUBILACIÓN O PENSIÓN EN NUESTRO BANCO, UN PORCENTAJE DE TUS INGRESOS SE TE DEVOLVERÁ COMO SALDO A FAVOR EN TU CUENTA PARA QUE PUEDAS UTILIZAR COMO QUIERAS!
            </p>
            <button className='bg-blue-600 rounded-md hover:bg-blue-500 mx-1 px-5 py-2 text-sm font-semibold text-white hover:text-black hover:ring-2 hover:ring-slate-400 hover:font-semibold lg:px-5 lg:py-1 xl:text-lg'>Más información</button>
          </div>
        ...
        <div className='grid grid-rows-4 mt-0 pl-4 pb-4 md:pl-3 md:mt-3 md:col-span-2 md:pl-9 md:pl-4 md:gap-1 lg:mx-10 lg:col-span-1 lg:grid-rows-2 lg:grid-cols-2 lg:mt-5 lg:py-4 lg:gap-2 xl:col-span-2 xl:grid-rows-2 xl:grid-cols-2 xl:gap-5 xl:mx-24 xl:mt-9 xl:py-3 2xl:col-span-2'>
