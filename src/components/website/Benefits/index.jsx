...
export default function Benefits() {
    return (
        <div className="wrapper flex-column h-screen">
            ...
            <div className="grid mt-7 w-auto h-fit md:grid-cols-4 md:space-x-4 lg:grid-cols-3 lg:space-x-9 xl:grid-cols-4 2xl:grid-cols-4">
                ...
                <div className="my-0 py-0 flex flex-col gap-5 md:px-4 md:py-4 md:flex-col lg:py-4 lg:flex-col lg:pr-5 xl:py-4 xl:flex-col 2xl:py-4 2xl:flex-col" id="row2">
                    <div className="bg-blue-300 text-center px-auto py-4 w-80 h-60 rounded-md ml-auto sm:w-44 sm:h-80 sm:ml-1 sm:py-2 sm:text-sm sm:space-y-1.5 md:px-2 md:space-y-0 md:py-2 md:w-48 md:h-72 lg:py-4 lg:w-80 lg:h-56 lg:space-y-1.5 xl:ml-0 xl:py-4 xl:w-80 xl:space-y-0.5 xl:h-56">
