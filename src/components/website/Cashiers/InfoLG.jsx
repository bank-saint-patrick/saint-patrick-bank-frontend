...
const InfoLG = () => {
    return (
        <div className="overflow-y-auto bg-gray-100 flex">
            <div className="mx-auto container max-h-screen px-4 xl:px-0 py-24">
                <h1 className="focus:outline-none text-center text-4xl font-extrabold leading-9 tracking-wider text-gray-900">¿Por qué elegirnos?</h1>
                <div className="mt-24 f-f-p">
                    <div className="flex justify-center w-full">
                        <div className="flex flex-col items-end pr-12 border-r-4 border-gray-300 relative w-1/2">
                            <div className="flex justify-end w-full" aria-label="sign up" role="img">
                                <img className="focus:outline-none w-32 h-32 object-cover my-24 bg-cream-can rounded-full" src={slides[0].image} alt="how it work" />
                            </div>
                            ...
                            <div className="flex flex-col items-end w-8/12">
                                ...
                                <h2 className="focus:outline-none text-gray-500 mt-3 text-right text-base leading-6 tracking-wide">{slides[1].description}</h2>
                            </div>
                            <div aria-label="transactions" role="img">
                                <img className="focus:outline-none w-32 h-32 object-cover mt-24 mb-16 bg-cream-can rounded-full" src={slides[2].image} alt="how it work" />
                            </div>
                            ...
                            <div className="flex flex-col items-end w-8/12">
                                ...
                                <h2 className="focus:outline-none text-gray-500 mt-3 text-right text-base leading-6 tracking-wide">{slides[3].description}</h2>
                            </div>
                            <div aria-label="transactions" role="img">
                        ...
                        <div className="flex flex-col items-start pl-12 border-gray-400 mt-20 w-1/2">
                            <div>
                                <b className="rounded-full py-2 px-4 text-2xl text-white bg-blue-stone">1</b>
                            </div>
                            <div className="flex mt-6 flex-col items-start w-8/12">
                            ...
                            <div aria-label="wallet" role="img">
                                <img className="focus:outline-none w-32 h-32 object-cover mt-36 mb-24 bg-cream-can rounded-full" src={slides[1].image} alt="how it work" />
                            </div>
                            ...
                            <div className="flex justify-start w-full" aria-label="sign up" role="img">
                                <img className="focus:outline-none w-32 h-32 object-cover mt-24 mb-16 bg-cream-can rounded-full" src={slides[3].image} alt="how it work" />
                            </div>
                            <div className="mt-24 mb-8">
                                <b className="rounded-full py-2 px-4 text-2xl text-white bg-blue-stone">5</b>
                            </div>
                            <div className="flex flex-col items-start w-8/12 mb-12">
                                <h1 className="focus:outline-none text-xl font-bold leading-5">{slides[4].title}</h1>
                                <h2 className="focus:outline-none text-gray-500 mt-3 text-left text-base leading-6 tracking-wide">{slides[4].description}</h2>
                            </div>
                        </div>
                    </div>
                </div>
